  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-journal-dir "~/org/personal/journal/")
     ;; (shell :variables
...
before packages are loaded."
    ...
    (setq org-capture-templates '(("t" "Todo [inbox]" entry
                                  ...
                                  ("w" "Project - Work" entry
                                  (file+headline "~/org/work/work.org" "Projects")
                                  "* %i%? [0/0]\n %U")

                                  ("p" "Project - Personal" entry
                                  (file+headline "~/org/personal/personal.org" "Projects")
                                  "* %i%? [0/0]\n %U")))

    (setq org-refile-targets '(("~/org/work/work.org" :maxlevel . 9)
                               ("~/org/someday.org" :maxlevel . 9)
                               ("~/org/inbox.org" :maxlevel . 1)
                               ("~/org/yt.org" :maxlevel . 9)
                               ("~/org/personal/personal.org" :maxlevel . 9)
                               ("~/org/reading.org" :maxlevel . 9)
                               ("~/org/snippets.org" :maxlevel . 9)
